...
function readConfig() {
  ...
  return {
    ...
    memoryV2DbPath: readTextEnv("MEMORY_V2_DB_PATH") || path.join(stateDir, "memory-v2.sqlite"),
    memoryV2RecallEnabled: readBoolEnv("MEMORY_V2_RECALL_ENABLED"),
    memoryV2RecallWriteEnabled: readBoolEnv("MEMORY_V2_RECALL_WRITE_ENABLED"),
    memoryV2RecallLimit: readIntEnv("MEMORY_V2_RECALL_LIMIT") || 5,
    memoryV2RecallBackupGate: {
      verified: readBoolEnv("MEMORY_V2_RECALL_BACKUP_VERIFIED"),
      directory: readTextEnv("MEMORY_V2_RECALL_BACKUP_DIR"),
      sha256: readTextEnv("MEMORY_V2_RECALL_BACKUP_SHA256"),
    },
